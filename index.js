...
app.put("/jokes/:id", (req, res) =>{
  ...
  const searchID = jokes.findIndex((jokes) => jokes.id === id);
...
app.patch("/jokes/:id", (req, res) =>{
  ...
  const searchID = jokes.findIndex((jokes) => jokes.id ===id);
  jokes[searchID] = replacementJoke;
  console.log(jokes[searchID]);
  res.json(jokes[searchID]);
});
...
app.delete("/jokes/:id", (req, res) =>{
  ...
  console.log(id + jokes[searchIndex]);
  if(searchIndex > -1){
    ...
    res
      .status(404)
      .json({error: `joke with id: ${id} is not found. no joke is deleted`});
  }
...
app.delete("/all", (req, res) =>{
  ...
  if(userKey === masterKey){
    ...
    res.json({error: "authorisation is needed"});
  }
})
